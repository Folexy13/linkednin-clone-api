...
exports.paymentNotifTemplate = exports.otpMailTemplate = exports.subscribeTemplate = exports.contactUsTemplate = void 0;
const contactUsTemplate = ({ name, email, phone, subject, message }) => __awaiter(void 0, void 0, void 0, function* () {
    return `
...
const subscribeTemplate = ({ firstName, email }) => __awaiter(void 0, void 0, void 0, function* () {
    return `
    <!DOCTYPE HTML PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    <html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
    <head>
...
exports.subscribeTemplate = subscribeTemplate;
const otpMailTemplate = ({ subject, body }) => {
    return `
...
const paymentNotifTemplate = ({ subject, body }) => {
    return `
...
exports.paymentNotifTemplate = paymentNotifTemplate;
